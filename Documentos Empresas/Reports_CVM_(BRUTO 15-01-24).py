...
tipo_doc = f"{search.iloc[4]['categoria']}"


# Concatenar o nome da empresa e a extensão do arquivo com a string da data e hora
file_name = f"C:\\Users\\julio.andrade\\OneDrive - bbce.com.br\\Área de Trabalho\\Códigos B3\\Planilhas\\Doc. Tipo " + tipo_doc + " da Empresa " + empresa + ".xlsx"
